...
var _zoomInOut = __webpack_require__(1);
    ...
    ************************************/
    ...
    function clickOnImgHandle(event) {
        ...
        if (overlay.style.height === "100%") {
            _zoomInOut.togglePopup.hidePopup(popup, overlay);
            popup.removeEventListener('wheel', wheelEventHandler);
        } else {

            _zoomInOut.togglePopup.showPopup(popup, overlay);
...
var togglePopup = exports.togglePopup = function () {
